...
function ProjectsPart2({projects}) {
    ...
    return (
        <>
            <section className="projects projects-part-2" id="projects-part-2">
                <Inner className="section-header">
                    <div>
                        <h2 className="section-title">Landing Pages & Frontend Apps</h2>
                        <hr />
                    </div>
                </Inner>
                <Inner className="projects-container projects-part-2-container">
...
function ProjectCard({ project, index, isHovered, setHoveredIndex, handleMouseMove, handleMouseLeave }) {
